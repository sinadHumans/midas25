...
use App\Http\Requests\IncapacidadStoreRequest;
use App\Http\Requests\IncapacidadUpdateRequest;
...
class IncapacidadController extends Controller
{
     ...
     public function muestro($id){
        ...
        $estudios = Incapacidad::where('idEstudio', $id)->get();
    ...
    public function crear(Request $request): JsonResponse{
        ...
        $user = Incapacidad::create($data);
    /* agregamos el accion */
    $accion = [ 'idUsuario' => session('email'), 'accion' => "Creación de incapacidad", ];
    ...
    public function editar(Request $request, $id){
        ...
        $updated = Incapacidad::where('id', $id)->update($data);

        /* agregamos el accion */
        $accion = [ 'idUsuario' => session('email'), 'accion' => "Edicion de incapacidad ", ];
        $acceso = Acciones::create($accion);
    ...
    public function eliminar($id)  {
        $empresa = Incapacidad::findOrFail($id); // Busca la empresa por ID
        $empresa->delete(); // Elimina la empresa
        /* agregamos el accion */
        $accion = [ 'idUsuario' => session('email'), 'accion' => "Eliminamos incapacidad ", ];
        $acceso = Acciones::create($accion);
