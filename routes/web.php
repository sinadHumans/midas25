...
Route::middleware(['auth'])->group(function () {
    ...
    /* editar Informacion */
    Route::get('/domicilio/editar/{id}',[DomicilioController::class,'editar'])->name('domicilio.editar');
    ...
    /* editar Informacion */
    Route::get('/documentos/editar/{id}',[DocumentacionController::class,'editar'])->name('documentos.editar');
    ...
    /* editar Informacion */
    Route::get('/estructura/editar/{id}',[EstructurafamiliarController::class,'editar'])->name('estructura.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/redes/editar/{id}',[RedesController::class,'editar'])->name('redes.editar');
    ...
    /* editar Informacion */
    Route::get('/conducta/editar/{id}',[ConductasocialController::class,'editar'])->name('conducta.editar');
    ...
    /* editar Informacion */
    Route::get('/situacion/editar/{id}',[SituacionController::class,'editar'])->name('situacion.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/deudas/editar/{id}',[DeudasController::class,'editar'])->name('deudas.editar');
    ...
    /* editar Informacion */
    Route::get('/entorno/editar/{id}',[EntornohabitacionalController::class,'editar'])->name('entorno.editar');
    ...
    /* editar Informacion */
    Route::get('/referenciap/editar/{id}',[RefepersonalesController::class,'editar'])->name('referenciap.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/antecedentesl/editar/{id}',[RefelaboralesController::class,'editar'])->name('antecedentesl.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/salud/editar/{id}',[SaludController::class,'editar'])->name('salud.editar');
    ...
    /* editar Informacion */
    Route::get('/resumen/editar/{id}',[ResumenController::class,'editar'])->name('resumen.editar');
    ...
    /* editar Informacion */
    Route::get('/hobby/editar/{id}',[HobbyController::class,'editar'])->name('hobby.editar');
    ...
    /* editar Informacion */
    Route::get('/beneficiario/editar/{id}',[BeneficiarioController::class,'editar'])->name('beneficiario.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/nivel/editar/{id}',[NivelacademicoController::class,'editar'])->name('nivel.editar');
    ...
    /* editar Informacion */
    Route::get('/periodo/editar/{id}',[PeriodoController::class,'editar'])->name('periodo.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/historitall/editar/{id}',[HistoriallaboralController::class,'editar'])->name('historitall.editar');
    ...
    /* editar Informacion */
    Route::get('/despidos/editar/{id}',[DespidosController::class,'editar'])->name('despidos.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/incapacidades/editar/{id}',[IncapacidadController::class,'editar'])->name('incapacidades.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/problemas/editar/{id}',[ProblemasController::class,'editar'])->name('problemas.editar');
    ...
    /* editar Informacion */
    Route::get('/infoLab/editar/{id}',[InfolaboralController::class,'editar'])->name('infoLab.editar');
    ...
    /* editar Informacion */
    Route::get('/creditos/editar/{id}',[CreditosController::class,'editar'])->name('creditos.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/infonavit/editar/{id}',[InfonavitController::class,'editar'])->name('infonavit.editar');
    ...
    /* editar Informacion */
    Route::get('/medico/editar/{id}',[ServiciomedicoController::class,'editar'])->name('medico.editar');
    ...
    /* editar Informacion */
    Route::get('/presentados/editar/{id}',[DocumentospresentadosController::class,'editar'])->name('presentados.editar');
    ...
    /* editar Informacion */
    Route::get('/grados/editar/{id}',[GradoEstudiosController::class,'editar'])->name('grados.editar');
    /* eliminar informacion */
    ...
    /* editar Informacion */
    Route::get('/investigaciones/editar/{id}',[InvestigacionsController::class,'editar'])->name('investigaciones.editar');
    ...
    /* editar Informacion */
    Route::get('/entornos/editar/{id}',[EntornosController::class,'editar'])->name('entornos.editar');
    ...
    /* editar Informacion */
    Route::get('/concluciones/editar/{id}',[ConclusionesController::class,'editar'])->name('concluciones.editar');
    /* eliminar informacion */
