                                ...
                                <div class="row">
                                    <div class="col-xl-10">
                                       {{--  {{ session('idEmpresa') }} /
                                        {{ session('tipo') }} /
                                        {{ session('email') }} /
                                        {{ session('usuarioCadena') }} / --}}
                                        <div class="alert alert-label-primary text-center" style="display: none;" id="alerta"><b>Acción realizada</b></div>
                                    </div>
                                    <div class="col-xl-2">
                                        {{-- Administrador --}}
                                        @if(session('tipo') == 'Administrador')
                                            <button class="btn btn-outline-success" style="width: 100%" data-bs-toggle="modal" data-bs-target="#modal11">Nuevo estudio </button>
                                        @endif
                                        {{-- Coordinador --}}
                                       ...
                                       {{--  @if(session('tipo') == 'Ejecutivo')
                                            <button class="btn btn-outline-success" style="width: 100%" data-bs-toggle="modal" data-bs-target="#modal11">Nuevo estudio Admin </button>
                                        @endif --}}
                                        {{-- Encuestador --}}
                                        ...
                                        @if(session('tipo') == 'Cliente Admin')
                                            <button class="btn btn-outline-success" style="width: 100%" data-bs-toggle="modal" data-bs-target="#modal112">Nuevo estudio </button>
                                        @endif
                                        {{-- Cliente Coordinador --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if(session('tipo') == 'Administrador')
                                                        ...
                                                        {{-- editar Cliente --}}
                                                        <a onclick="edicionEstudioCliente({{$empresa}})"><button class="btn btn-outline-warning"><i class="fas fa-user-edit"></i></button></a>
                                                        @if ($empresa->estatus != 3 && $empresa->estatus != 3)
                                                            {{-- calncelar Cliente --}}
                                                            <a onclick="cancelarEstudioCliente({{ $empresa->id}})"><button class="btn btn-outline-danger"><i class=" far fa-trash-alt"></i></button></a>
                                                        @endif
                                                        {{-- resulemn --}}
...
{{-- modal de creacion administrador coordinador --}}
                    ...
                    <div class="card portlet border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <label for="exampleFormControlInput1" class="form-label">Solicita</label>
                                    <div id="select-containerCli"></div>
                                </div>
...
{{-- modal de creacion cliente cliente admin cliente coordinador --}}
<div class="modal fade" id="modal112" tabindex="-1" role="dialog" aria-labelledby="modal1Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal1Label">Nuevo registro</h5>
            ...
            <form id="crearEstudio">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" id="idUsuariocli" name="idUsuario" value="{{ session('email') }}" />
                    <input type="hidden" class="form-control" id="idEmpresacli" name="idEmpresacli" value="{{ session('idEmpresa') }}" />
                    <input type="hidden" class="form-control" id="fechaSolicitudcli" name="fechaSolicitudcli" value="{{ session('idEmpresa') }}" />
                    ...
                    <div class="card portlet border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label for="exampleFormControlInput1" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="nombreCandidatocli" name="nombreCandidato"  />
                                </div>

                                <div class="col-lg-4">
                                    <label for="exampleFormControlInput1" class="form-label">Apellido paterno</label>
                                    <input type="text" class="form-control" id="apePaternocli" name="apePaterno"  />
                                </div>

                                <div class="col-lg-4">
                                    <label for="exampleFormControlInput1" class="form-label">Apellido materno</label>
                                    <input type="text" class="form-control" id="apeMaternocli" name="apeMaterno"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Edad</label>
                                    <input type="text" class="form-control" id="edadcli" name="edad"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Sexo</label>
                                    <select class="form-control"  id="sexocli" name="sexo">
                                        @foreach (config('catalogos.cattiposSexo') as $key => $value)
                                            <option value="{{ $key }}"> {{ $value }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Estado Civil</label>
                                    <select class="form-control"  id="estadoCivilcli" name="estadoCivil">
                                        @foreach (config('catalogos.catestadosCiviles') as $key => $value)
                                            <option value="{{ $key }}"> {{ $value }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Hijos</label>
                                    <input type="number" class="form-control" id="hijoscli" name="hijos"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">NSS</label>
                                    <input type="text" class="form-control" id="nsscli" name="nss"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">RFC</label>
                                    <input type="text" class="form-control" id="rfccli" name="rfc"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">CURP</label>
                                    <input type="text" class="form-control" id="curpcli" name="curp"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Lugar de nacimiento</label>
                                    <input type="text" class="form-control" id="lugarNacimientocli" name="lugarNacimiento"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Fecha Nacimiento</label>
                                    <input type="date" class="form-control" id="fechaNacimientocli" name="fechaNacimiento"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nacionalidad</label>
                                    <input type="text" class="form-control" id="nacionalidadcli" name="nacionalidad"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Puesto</label>
                                    <input type="text" class="form-control" id="puestocli" name="puesto"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Tipo de servicio</label>
                                    <select class="form-control"  id="tiposerviciocli" name="tiposervicio">
                                        @foreach (config('catalogos.servicios') as $key => $value)
                                            <option value="{{ $key }}"> {{ $value }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Escolaridad</label>
                                    <select class="form-control"  id="escolaridadcli" name="escolaridad">
                                        @foreach (config('catalogos.catnivelesEscolaridad') as $key => $value)
                                            <option value="{{ $key }}"> {{ $value }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="card portlet border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Télefono</label>
                                    <input type="text" class="form-control" id="telefonocli" name="telefono"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Correo</label>
                                    <input type="mail" class="form-control" id="correocli" name="correo"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Celular</label>
                                    <input type="text" class="form-control" id="celularcli" name="celular"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Otro contacto</label>
                                    <input type="text" class="form-control" id="otroContactocli" name="otroContacto"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Infonavit</label>
                                    <input type="text" class="form-control" id="infonavitcli" name="infonavit"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Fonacot</label>
                                    <input type="text" class="form-control" id="fonacotcli" name="fonacot"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Clinica IMSS</label>
                                    <input type="text" class="form-control" id="clincaImsscli" name="clincaImss"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Vive con</label>
                                    <input type="text" class="form-control" id="viveConcli" name="viveCon"  />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Dirección</label>
                                    <input type="text" class="form-control" id="direccioncli" name="direccion"  />
                                </div>
                    ...
                    <div class="card portlet border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Curriculum</label>
                                    <input type="file" class="form-control" id="fileInputccli" />
                                </div>

                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">Foto</label>
                                    <input type="file" class="form-control" id="fileInputfcli" />
                                </div>
                                <textarea name="curriculum" style="display: none " id="outputBase64ccli" cols="30" rows="3" ></textarea>
                                <textarea name="foto" style="display: none " id="outputBase64fcli" cols="30" rows="3" ></textarea>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btnCrearCli">Registrar</button>
                </form>
                    <button class="btn btn-outline-danger" data-bs-dismiss="modal" aria-label="Close">Cerrar</button>
                </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="crearEstudio">
                @csrf
                <div class="modal-body">
                    <input type="text" class="form-control" id="idEstudioEdiCli" name="idEstudioEdiCli" />
...
<script type="text/javascript">
            ...
            success: function(response) {
               ...
               const select = document.createElement('select');
                ...
                datos.forEach(item => {
                    ...
                    option.text = item.email; // Usar el nombre como texto visible
                    select.appendChild(option);
                });
    ...
    catCliente()
    function catCliente(){
        var url = `/usuarios/relacionClientes/`;
        $.ajax({
            url: url,
            method: 'GET',
            success: function(response) {
               ...
               const select = document.createElement('select');
                ...
                // Agregar el <select> al contenedor en el DOM
                document.getElementById('select-containerCli').appendChild(select);
            },
            error: function(response) { alert('Error al editar la empresa.'); }
        });
    }

    function catClienteEdi(){
        var url = `/usuarios/relacionClientes/`;
        $.ajax({
            url: url,
            method: 'GET',
            success: function(response) {
               ...
               const select = document.createElement('select');
                ...
                // Agregar el <select> al contenedor en el DOM
                document.getElementById('select-containerCliedi').appendChild(select);
            },
            error: function(response) { alert('Error al editar la empresa.'); }
        });
    }
    ...
    /* boton crear cliente */
    $('#btnCrearCli').click(function(e) {
        e.preventDefault(); // Previene el envío normal del formulario
        /* var formData = $(this).serialize(); */ // Obtiene los datos del formulario
        var url = '{{ route('estudio.crear') }}';
        var formData = {

                idUsuario: $('#idUsuariocli').val(),
                idEmpresa: $('#idEmpresacli').val(),
                nombreCandidato: $('#nombreCandidatocli').val(),
                apePaterno: $('#apePaternocli').val(),
                apeMaterno: $('#apeMaternocli').val(),
                puesto: $('#puestocli').val(),
                fechaSolicitud: new Date().toISOString(),
                rfc: $('#rfccli').val(),
                curp: $('#curpcli').val(),
                archivo: $('#outputBase64fcli').val(),
                encuestador: $('#encuestadorcli').val(),
                fechaCita: $('#fechaCitacli').val(),
                nss: $('#nsscli').val(),
                tiposervicio: $('#tiposerviciocli').val(),
                telefono: $('#telefonocli').val(),
                correo: $('#correocli').val(),
                sexo: $('#sexocli').val(),
                edad: $('#edadcli').val(),
                estadoCivil: $('#estadoCivilcli').val(),
                lugarNacimiento: $('#lugarNacimientocli').val(),
                fechaNacimiento: $('#fechaNacimientocli').val(),
                escolaridad: $('#escolaridadcli').val(),
                hijos: $('#hijoscli').val(),
                nacionalidad: $('#nacionalidadcli').val(),
                viveCon: $('#viveConcli').val(),
                direccion: $('#direccioncli').val(),
                celular: $('#celularcli').val(),
                otroContacto: $('#otroContactocli').val(),
                infonavit: $('#infonavitcli').val(),
                fonacot: $('#fonacotcli').val(),
                cv: $('#outputBase64ccli').val(),
                clincaImss: $('#clincaImsscli').val(),
    ...
    /* pra los clientes */
    document.getElementById('fileInputccli').addEventListener('change', async (event) => {
        const input = event.target;
        ...
        try {
            ...
            // Mostrar el resultado en el textarea
            document.getElementById('outputBase64ccli').value = optimizedBase64;
        } catch (error) {
            console.error("Error al procesar el archivo:", error);
            alert("Hubo un error al procesar el archivo.");
        }
    ...
    /* para el aedicion de archivo */
    document.getElementById('fileInputfcli').addEventListener('change', async (event) => {
        const input = event.target;
        ...
        try {
            ...
            // Mostrar el resultado en el textarea
            document.getElementById('outputBase64fcli').value = optimizedBase64;
        } catch (error) {
            console.error("Error al procesar el archivo:", error);
            alert("Hubo un error al procesar el archivo.");
        }
